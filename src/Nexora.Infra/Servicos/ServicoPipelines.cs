...
public class ServicoPipelines(NexoraDbContext db, IContextoEmpresa contexto) : IServicoPipelines
{
    ...
    ///
    /// Eu tinha posto 8 no papel. `lateral.spec.ts` montou o menu com 8 e mediu: passava 57px.
    /// Desceu para 6. Aí o merge com a branch de etiquetas trouxe mais um item fixo para a
    /// Configuração, e a mesma medição acusou 32px — desceu para 5.
    ///
    /// Duas vezes seguidas o número caiu por causa de coisa que não tem nada a ver com pipeline:
    /// é o preço de a barra ser um recurso fixo e as pipelines serem a única parte elástica dela.
