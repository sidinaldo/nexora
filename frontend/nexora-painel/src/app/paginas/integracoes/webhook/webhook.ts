 ...
 *
 *  ===================== É PAINEL, NÃO PÁGINA (INT-4) =====================
 *  Ele era a tela inteira. Virou uma aba, e com isso perdeu `.pagina`, `<h1>` e o subtítulo: quem
 *  desenha o cabeçalho agora é o container, senão a tela teria dois títulos.
 *
 *  Mesmo movimento que a Captação já fez com os painéis dela, e pela mesma razão: a segunda coisa
 *  que o Nexora integra (os anúncios) responde à MESMA pergunta do cliente — "o que isto conversa
 *  com o resto do mundo?" — e uma tela por parceiro faria o menu crescer um item por integração.
 *  ========================================================================
 *
 *  ===================== O QUE ESTE PAINEL PRECISA ENTREGAR =====================
