...
export class Contatos implements OnInit {
  ...
  // ⚠️ AQUI MORAVA O MODAL DE IMPORTAR (issue #8), com dois passos e um seletor de funil. Ele
  // foi ABSORVIDO pela tela `/importar` (INT-XX), que pergunta o que cada coluna do arquivo
  // significa — uma tabela que não cabe num modal. Duas telas de importar seriam a duplicata que
  // este projeto passa o tempo desmontando.
