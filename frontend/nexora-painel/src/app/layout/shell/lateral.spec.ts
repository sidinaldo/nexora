...
describe('barra lateral — três zonas, densidade e status', () => {
  ...
  it('A BARRA NÃO ROLA EM 768px DE ALTURA, COM O MENU NO PIOR CASO', async () => {
    ...
    // cartão de primeiros passos. Se a densidade regredir, este é o teste que acusa — e acusa
    // dizendo QUANTOS pixels sobraram do lado de fora.
    //
    ...
    //
    // Então o teste passa a montar o TETO, que é o que `ServicoPipelines` permite.
    // ⚠️ O TETO JÁ CAIU DUAS VEZES AQUI. Começou em 8 (passava 57px), desceu para 6, e quando o
    // merge com as etiquetas trouxe mais um item fixo para a Configuração passou a 32px — desceu
    // para 5. Nas duas vezes o motivo veio de fora das pipelines: a barra é recurso fixo e elas
    // são a única parte elástica. O número é medido, não escolhido.
    // =======================================================================
